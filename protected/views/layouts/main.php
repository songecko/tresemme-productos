...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Landing Page', 'url'=>array('/landing/update&id=1')),
				array('label'=>'Colecciones', 'url'=>array('/collections/index')),
				array('label'=>'Productos', 'url'=>array('/products/index')),
